...
function MyComboBox<T extends object>({
  ...
  return (
    ...
    >
      ...
      <Group className="flex rounded-lg border-0 bg-white/90 shadow-md transition rac-focus-visible:ring-2 rac-focus-visible:ring-primary rac-focus-within:bg-white/100">
...
export default function DemoCombobox() {
  ...
  return (
    <section className="flex flex-wrap gap-3 rounded border p-3">
      <div>
        <p>Current selected major id: {fieldState.selectedKey?.toString()}</p>
